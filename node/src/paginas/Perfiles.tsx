...
import { addData, deleteData, getDatos, setData } from "../servicios/PerfilesService";
...
export async function loader() {
    const datos: PerfilInterface[] = await getDatos();
    return [datos];
}
...
const Perfiles = () => {
    ...
    let [datos] = useLoaderData() as [PerfilInterface[]];
    ...
    */
    const handleEditar = (modulo: PerfilInterface) => {
                                        ...
                                        <div className="card-body">
                                            <div className="table-responsive">
                                                <table className="table table-bordered table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        {datos.map((dato: PerfilInterface) =>
                                                        (
                                                            <tr key={dato.id}>
                                                                <td>{dato.id}</td>
                                                                <td>{dato.nombre}</td>
...
import Header from "../componentes/Header"
import Menu from "../componentes/Menu"
import { getDatos } from "../servicios/PerfilesService";
import { Link, useLoaderData } from "react-router-dom";
export async function loader() {
                                                        ...
                                                        (
                                                            <tr key={dato.id}>
                                                                ...
                                                                <td className="text-center">
                                                                    ...
                                                                    <Link to="#" onClick={() => {  }} title="Editar">
                                                                        <i className="fas fa-edit"></i>
                                                                    </Link>
                                                                    &nbsp;&nbsp;
                                                                    <Link onClick={ () => {  }} to="#" title="Eliminar"><i className="fas fa-trash"></i></Link>
                                                                </td>
                                                            </tr>
                                                        ))}
