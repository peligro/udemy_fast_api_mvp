...
import { addData, deleteData, getDatos, setData } from "../../servicios/PlatosCategoriasService";
...
export async function loader() {
    const datos: PlatosCategoriaInterface[] = await getDatos();
    return [datos];
}

const PlatosCategorias = () => {
    ...
    let [datos] = useLoaderData() as [PlatosCategoriaInterface[]];
    //ventana modal
    ...
    const handleEditar = (modulo: PlatosCategoriaInterface) => {
                    ...
                    <main className="content">
                        <div className="container-fluid p-0">
                            <Breadcrumb>
                                ...
                                <Breadcrumb.Item active>Platos categoría</Breadcrumb.Item>
                            </Breadcrumb>
                                        ...
                                        <div className="card-body">
                                            <div className="table-responsive">
                                                <table className="table table-bordered table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        {datos.map((dato: PlatosCategoriaInterface) =>
                                                        (
                                                            <tr key={dato.id}>
                                                                <td>{dato.id}</td>
                                                                <td>{dato.nombre}</td>
...
export default PlatosCategorias
